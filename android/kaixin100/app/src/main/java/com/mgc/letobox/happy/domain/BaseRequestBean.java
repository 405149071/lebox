...
public class BaseRequestBean {
    private String app_id = SdkConstant.MGC_APPID; //是	INT	游戏ID
    private String client_id = SdkConstant.MGC_CLIENTID;    //	是	INT	客户端ID
    private String from = SdkConstant.FROM;   //	是	INT	来源信息 1-WEB、2-WAP、3-Android、4-IOS、5-WP
    private String agentgame = SdkConstant.MGC_AGENT;    //是	STRING	玩家所属渠道 默认为’’
