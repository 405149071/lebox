package com.mgc.letobox.happy.config;
...
import static com.leto.game.base.http.SdkConstant.BASE_URL;
...
public class SdkApi {
    ...
    public static String app_wallet_trans_url_prefix = "http://60.205.168.253/trx/";
    public static String app_redpacket_share_url_prefix = "http://hb.mgc-games.com/index.php/Hbshare/share.html?red_envelop_id=";
    ...
    private static String getRequestUrl() {
        ...
        if (!TextUtils.isEmpty(BASE_URL) || !TextUtils.isEmpty(SdkConstant.BASE_IP)) {
            requestUrl = BASE_URL + SdkConstant.BASE_SUFFIX_URL;
...
//            }
    ...
    public static String getStartup() {
        printUrl("system/hzstartup");
        return getRequestUrl() + "system/hzstartup";
    }
    ...
    public static String getDrawCashApply() {
        printUrl("wx/kxapply");
        return getRequestUrl() + "wx/kxapply";
    }
    ...
    public static String getServiceAgreement() {
        L.e(TAG, "http_url=" + BASE_URL + "/index.php?s=index/mgcqb_user_agreement.html");
    ...
    public static HttpParams getCommonHttpParams(String apiName) {
        ...
        httpParams.put("sign", MD5.md5(new StringBuffer(apiName).append(timestamp).append(SdkConstant.MGC_CLIENTKEY).toString()));
